...
import alex from '../static/video-headshot/AlexHS.mp4';
import ally from '../static/video-headshot/AllyHS.mp4';
import amanda from '../static/video-headshot/AmandaHS.mp4';
import angelina from '../static/video-headshot/AngelinaHS.mp4';
import anna from '../static/video-headshot/AnnaHS.mp4';
import ann from '../static/video-headshot/AnnHS.mp4';
import bella from '../static/video-headshot/BellaHS.mp4';
import brooke from '../static/video-headshot/brookeHS.mp4';
import caleb from '../static/video-headshot/calebHS.mp4';
import clara from '../static/video-headshot/ClaraHS.mp4';
import cynthia from '../static/video-headshot/CynthiaHS.mp4';
import dylan from '../static/video-headshot/DylanHS.mp4';
import emily from '../static/video-headshot/EmilyHS.mp4';
import fallon from '../static/video-headshot/FallonHS.mp4';
import florencia from '../static/video-headshot/FlorenciaHS.mp4';
import gerard from '../static/video-headshot/GerardHS.mp4';
import gina from '../static/video-headshot/GinaHS.mp4';
import giuli from '../static/video-headshot/GiuliHS.mp4';
import heather from '../static/video-headshot/HeatherHS.mp4';
import ivanna from '../static/video-headshot/IvannaHS.mp4';
import jacob from '../static/video-headshot/JacobHS.mp4';
import jennifer from '../static/video-headshot/JenniferHS.mp4';
import lauren from '../static/video-headshot/LaurenHS.mp4';
import liana from '../static/video-headshot/Liana.mp4';
import liv from '../static/video-headshot/LivHS.mp4';
import lucas from '../static/video-headshot/LucasHS.mp4';
import marivi from '../static/video-headshot/Marivi.mp4';
import nina from '../static/video-headshot/NinaHS.mp4';
import pat from '../static/video-headshot/PatHS.mp4';
import preston from '../static/video-headshot/PrestonHS.mp4';
import prstud from '../static/video-headshot/PRStudentHS.mp4';
import quincy from '../static/video-headshot/QuincyHS.mp4';
import ryan from '../static/video-headshot/Ryan2HS.mp4';
import ryan2 from '../static/video-headshot/RyanHS.mp4';
import sam from '../static/video-headshot/SamanthaHS.mp4';
import taylor from '../static/video-headshot/TaylorHS.mp4';
import thomas from '../static/video-headshot/ThomasHS.mp4';
import yondi from '../static/video-headshot/YondiHS.mp4';
